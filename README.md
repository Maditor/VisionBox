...
- Bấm **"+ Add images (max 30)"** để chọn ảnh từ máy (chọn được nhiều ảnh cùng lúc).
- Hoặc **kéo–thả** ảnh trực tiếp vào vùng làm việc.

Giới hạn tối đa **30 ảnh** mỗi lần làm việc. Ảnh trùng tên + trùng dung lượng với ảnh đang có sẵn trong danh sách sẽ tự động bị bỏ qua để tránh nhân đôi.
